...
CREATE TABLE `biblioteca` (
  ...
  `analisis_modo` enum('armado','archivo') DEFAULT NULL,
  `analisis_pdf_url` varchar(500) DEFAULT NULL,
  `analisis_pdf_nombre_original` varchar(255) DEFAULT NULL,
...
CREATE TABLE `jugadores` (
  ...
  `nacionalidad_2_tramite` enum('sin_iniciar','en_curso','finalizado') DEFAULT NULL,
  `posicion` varchar(50) DEFAULT NULL,
  `categoria` varchar(100) DEFAULT NULL,
  `division_nombre` varchar(100) DEFAULT NULL,
  `contrato` enum('si','no') DEFAULT NULL,
  `contrato_hasta_mes` enum('julio','diciembre') DEFAULT NULL,
  `contrato_hasta_anio` smallint DEFAULT NULL,
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `semaforo_riesgo_ia` enum('verde','amarillo','rojo') DEFAULT NULL,
  `motivo_riesgo_ia` varchar(300) DEFAULT NULL,
  `riesgo_ia_actualizado_en` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `usuario_id` (`usuario_id`),
...
CREATE TABLE `nutricion_evaluaciones` (
  ...
  `masa_adiposa_kg` decimal(5,2) DEFAULT NULL,
  `sumatoria_pliegues` decimal(6,2) NOT NULL,
  `masa_osea_kg` decimal(5,2) DEFAULT NULL,
  `masa_residual_kg` decimal(5,2) DEFAULT NULL,
  `masa_piel_kg` decimal(5,2) DEFAULT NULL,
  `indice_musculo_oseo` decimal(5,2) DEFAULT NULL,
  `observaciones` text,
  `registrado_por` int NOT NULL,
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `dietas_jugador` (
  ...
  `jugador_id` int NOT NULL,
  `plan` text,
  `modo` enum('armado','archivo') DEFAULT NULL,
  `secciones_json` longtext,
...
CREATE TABLE `microciclo_bloques` (
  ...
  `tipo_actividad` enum('general','preparador_fisico','cancha','viaje') DEFAULT NULL,
  ...
  `espacio_trabajo` enum('completa','media','reducido','gimnasio') DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `jugador_videos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
